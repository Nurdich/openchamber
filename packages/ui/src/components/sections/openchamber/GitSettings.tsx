  ...
  return (
    <div className="mb-8">
      <div className="mb-1 px-1">
        <h3 className="typography-ui-header font-medium text-foreground">Git 偏好设置</h3>
      </div>
      ...
      <section className="px-2 pb-2 pt-0 space-y-0.5">
        ...
        >
          <Checkbox
            ...
            ariaLabel="显示 gitignore 的文件"
          />
          <span className="typography-ui-label text-foreground">显示 Gitignore 文件</span>
        </div>
      </section>
    </div>
  );
