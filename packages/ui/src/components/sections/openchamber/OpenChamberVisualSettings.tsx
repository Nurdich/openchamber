...
const DEFAULT_PWA_INSTALL_NAME = '打开Chamber - AI Coding Assistant';
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        label: '排序',
        description: '渲染已完成的助手消息，不使用实时流式传输。',
    },
    {
        id: 'live',
        label: '实时',
        description: '实时流式传输助手文本和工具。',
    },
];
...
export const OpenChamberVisualSettings: React.FC<OpenChamberVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const formatThemeLabel = React.useCallback((themeName: string, variant: 'light' | 'dark') => {
        const suffix = variant === 'dark' ? ' 深色' : ' 浅色';
                            ...
                            {showPwaInstallNameSetting && (
                                <div className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        ...
                                        <span className="typography-meta text-muted-foreground">PWA 安装流程使用。</span>
                                    </div>
                                ...
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <div className="flex items-center gap-1.5">
                                            <span className="typography-ui-label text-foreground">输入框偏移</span>
                                            <Tooltip delayDuration={1000}>
                                                <TooltipTrigger asChild>
                                                    <RiInformationLine className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                                </TooltipTrigger>
                                                <TooltipContent sideOffset={8} className="max-w-xs">
                                                    抬起输入框以避免操作系统级别的屏幕遮挡，如底部安全区域。
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-[minmax(0,16rem)_minmax(0,16rem)] md:justify-start md:gap-x-2">
                                    {shouldShow('chatRenderMode') && (
                                        <section className="p-2 md:col-span-2">
                                            ...
                                            <div role="radiogroup" aria-label="聊天 render mode" className="mt-1 grid w-full max-w-[26rem] grid-cols-1 gap-3 sm:grid-cols-2">
                                    ...
                                    {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                        <section className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">Activity 默认</h4>
                                            <div role="radiogroup" aria-label="Activity 默认模式" className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={`Activity 默认 mode: ${option.label}`}
                                                            />
                                    ...
                                    {shouldShow('expandedTools') && (
                                        <section className="p-2 md:col-span-2 space-y-0.5">
                                            <div className="typography-ui-header font-medium text-foreground py-1.5">默认展开工具:</div>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">Diff 布局</h4>
                                            <div role="radiogroup" aria-label="Diff 布局" className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={`Diff 布局: ${option.label}`}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {option.label}
                                                            </span>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">Diff 查看模式</h4>
                                            <div role="radiogroup" aria-label="Diff 查看模式" className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={`Diff 查看模式: ${option.label}`}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {option.label}
                                                            </span>
                                    ...
                                    {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel="显示隐藏文件"
                                            />
                                            <span className="typography-ui-label text-foreground">显示隐藏文件</span>
                                        </div>
                                    )}
                                        ...
                                        >
                                            ...
                                            <span className="typography-ui-label text-foreground">默认排队消息</span>
                                                <Tooltip delayDuration={1000}>
                                                    ...
                                                    <TooltipContent sideOffset={8} className="max-w-xs">
                                                        启用后，Enter 键会将消息排队。使用 {getModifierLabel()}+Enter 发送。
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </div>
